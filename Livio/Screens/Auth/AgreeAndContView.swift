            ...
            VStack(alignment: .leading){
                ...
                VStack(alignment: .leading){
                    Button{
                        ...
                        PrimaryButton(title: "Agree & Continue", isBackgroundColor: true, isBorder: false, titleColor: .white, backgroudColor: .goldenrod500)
                    }.padding(.bottom, 8)
                    ...
                    Button{
                        ...
                        PrimaryButton(title: "Disagree", isBackgroundColor: false, isBorder: true, titleColor: .primaryButton, backgroudColor: .primaryButton)
                    }
                }
            }
